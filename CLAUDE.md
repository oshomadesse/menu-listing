...
tags:
  ...
  - done
project_name: 🍳 献立作成くん
summary: 献立作成→食材抽出→買い物リスト出力を自動化するエージェントシステム
---
# 献立作成くん - 仕様書
...
- **出力先**: `11_Engineering/🍳 menu-listing/data/{YYYY-MM-DD}-食材リスト-{N}人分.md`
...
`11_Engineering/🍳 menu-listing/data/{YYYY-MM-DD}-食材リスト-{N}人分.md`（カンマ区切り、ヘッダー行なし）

```
野菜,にんじん,3本,1日目肉じゃが2本+3日目カレー1本
野菜,玉ねぎ,2個,1日目肉じゃが+3日目カレー
精肉,豚バラ薄切り,400g,2日目豚バラ大根
調味料,醤油,大さじ5,複数日で使用
```
